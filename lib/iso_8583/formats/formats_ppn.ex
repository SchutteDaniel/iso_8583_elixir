    ...
    do: %{
      ...
      "120": %{
        ...
        sub_fields: %{
          ...
          "120.47": %{content_type: "ans", label: "Original Transaction Detail", len_type: "fixed", max_len: 36},
          "120.50": %{content_type: "ans", label: "Remitter Proc Info", len_type: "fixed", max_len: 15},
          "120.56": %{content_type: "ans", label: "Channel Indicator", len_type: "fixed", max_len: 3},
