  ...
  def formats_definitions,
    do: %{
      ...
      "120": %{
        ...
        max_len: 999,
        sub_fields: %{
          "120.1": %{content_type: "ans", label: "Transaction Type", len_type: "lllvar", max_len: 999},
          "120.45": %{content_type: "ans", label: "Remitter Name", len_type: "lllvar", max_len: 999},
          "120.46": %{content_type: "ans", label: "Beneficiary Name", len_type: "lllvar", max_len: 999},
          "120.47": %{content_type: "ans", label: "Original Transaction Detail", len_type: "llvar", max_len: 36},
          "120.50": %{content_type: "ans", label: "Remitter Proc Info", len_type: "llvar", max_len: 15},
          "120.56": %{content_type: "ans", label: "Channel Indicator", len_type: "llvar", max_len: 3},
          "120.62": %{content_type: "ans", label: "Beneficiary Account Number", len_type: "lllvar", max_len: 999},
          "120.70": %{content_type: "ans", label: "Remitter Address", len_type: "lllvar", max_len: 999},
          "120.71": %{content_type: "ans", label: "Remitter SWIFT Code (BIC)", len_type: "lllvar", max_len: 999},
          "120.72": %{content_type: "ans", label: "Beneficiary Address", len_type: "lllvar", max_len: 999},
          "120.73": %{content_type: "ans", label: "Beneficiary SWIFT Code (BIC)", len_type: "lllvar", max_len: 999},
          "120.74": %{content_type: "ans", label: "Transaction Reason", len_type: "lllvar", max_len: 999},
          "120.75": %{content_type: "ans", label: "Remitter Transaction Reference", len_type: "lllvar", max_len: 999}
        }
      },
      "121": %{
        content_type: "n",
